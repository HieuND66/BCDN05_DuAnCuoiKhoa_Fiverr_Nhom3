          ...
          <div className="header-row max-width-container equal-padding row-main">
            ...
            <nav className='fiverr-nav fiverr-nav-right'>
              <ul>
                ...
                <li className="display-from-md">
                  <a href="/" className="aDeZs5- business-nav-link nav-link" target="_blank">USD</a>
                </li>
                <li className="display-from-md">
                  <a href="/" className="aDeZs5- business-nav-link nav-link" target="_blank">Become a Seller</a>
                </li>
                <li className="display-from-md">
                  <NavLink to='/login' className="aDeZs5- business-nav-link nav-link signIn " onClick={openModal} >Sign in</NavLink>
